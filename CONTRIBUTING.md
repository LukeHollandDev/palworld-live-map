...
5. For visible UI, demo-data, map-artwork, or walkthrough changes, run `make demo-media` and commit the regenerated `assets/images/demo.png` and `demo.gif`. Update the walkthrough when a new overview-worthy feature is not already demonstrated.
